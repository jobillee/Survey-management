...
const DashboardLayout = ({ children }) => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      else console.error('Failed to fetch profile:', error.message);
    };
  ...
  return (
    <div className="min-h-screen flex pl-70">
      <Sidebar profile={profile} />

      <div className="flex-1 min-h-screen flex flex-col">
        <header
          className="sticky top-0 z-30 px-8 py-4 flex items-center justify-between bg-white bg-opacity-90 backdrop-blur-md border-b border-gray-200"
        >
          <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <input
                type="text"
                placeholder="Search..."
                className="w-64 px-4 py-2 pl-10 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              />
